/*
    <PL / SQL>
    PROCEDUER LANGUAGE EXTENSION TO SQL
    ...
    * PL/SQL 구조
     - [선언부] : DECLAARE로 시작, 변수나 상수를 선언 및 초기화하는 부분
...
/*
    ...
    EXCEPTION
        ...
        * 시스템 예외(오라클에서 미리 정의해둔 예외)
         ...
         - TOO_MANY_ROWS : SELECT한 결과의 행이 너무 많을 경우
...
--    WHEN ZERO_DIVIDE THEN DBMS_OUTPUT.PUT_LINE('나누기 연산 시 0으로 나눌 수 없다.');
    WHEN OTHERS THEN DBMS_OUTPUT.PUT_LINE('나누기 연산 시 0으로 나눌 수 없다.');
END;
/
